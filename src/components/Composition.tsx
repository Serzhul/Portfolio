    ...
    <section className="section-about">
      <div className="u-center-text u-margin-bottom-big">
        <h2 className="heading-secondary">
          Exciting tours htmlFor adventruous people
        </h2>
      </div>
      ...
      <div className="row">
        <div className="col-1-of-2">
          ...
          <p className="paragraph">
            ...
            suscipit eaque ipsam dolor, magni provident itaque reprehenderit
            quia nisi, quibusdam cumque quam ad atque ipsa molestias
            perspiciatis, ullam illo? Accusantium?
          </p>
